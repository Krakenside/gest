...
$req ="SELECT DISTINCT transactionId FROM transaction_table WHERE itemId='".$_GET['tx']."'";

          $tr  = $bdd ->query($req);
          $nb_tran = $tr -> rowCount();

$req1 ="SELECT DISTINCT transactionId FROM transaction_table WHERE itemId='".$_GET['tx']."' AND statut ='SUCCESS'";
