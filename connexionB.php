...
try{
              ...
              $bdd =    new PDO ('mysql:host=localhost; dbname=afrekply;charset=utf8', 'RuT', 'projetafricai', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION, PDO::ATTR_PERSISTENT => false));
		}
           catch (Exception $e) {
             //$errorCod = $e->errorCode();
             echo $e->errorInfo[0];
             echo $e->errorInfo[1];
             if ( $e->errorInfo[0] == 28000 AND $e->errorInfo[1] == 1045) {
               echo 'ee';
               try{
