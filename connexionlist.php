...
try{
              ...
              $bdd = new PDO ('mysql:host=localhost; dbname=afrekply;charset=utf8', 'afplistAAS', 'projetafricain', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION, PDO::ATTR_PERSISTENT => false));
		}
           catch (Exception $e) {
