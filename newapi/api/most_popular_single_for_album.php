<?php
    ...
    $stmt = $items->getMostPopularSingleForAlbum();
    ...
    if($itemCount > 0){
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
            ...
            $lastdownloads = $items->getNbDownloadSingleBetweenPeriode('album'+$album['titre_album']+'-'+$id_album)->fetch(PDO::FETCH_ASSOC);
            if($lastdownloads['downloads']>=10){
            $e = array(
                "id" => $id_son,
