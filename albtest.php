            ...
            <div class="content-wrapper">
                ...
                <form method='POST' action='ajaxfile.php' enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        ...
                        <input name="dateSortie_album" type="text" class="form-control" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask="">

                    </div>

                    <label style="margin-top:15px;">Artiste</label>

                    <select name="id_artiste" class="form-control select2 select2-hidden-accessible" id="lart" style="width: 100%;" tabindex="-1" aria-hidden="true">
