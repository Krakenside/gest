  ...
  <header class="main-header">
    ...
    <a href="acceuil.php" class="logo">
      ...
      <span class="logo-lg"><b>AfreekaPlay </b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
            ...
            <ul class="dropdown-menu scale-up">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small class="mb-5"><?php echo $_SESSION["user_mail"]; ?></small>
                </p>
              </li>
             <li class="user-footer">
                <div class="pull-left">
                  <a href="#" class="btn btn-block btn-primary"><i class="ion ion-locked"></i> Verrouiller</a>
                </div>
                <div class="pull-right">
                  <a href="#" class="btn btn-block btn-danger"><i class="ion ion-power"></i> Deconnexion</a>
                </div>
              </li>
            </ul>
          </li>
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu scale-up">
              <li class="header">Pas de nouveaux messages</li>
               <!--<li>
              ...
              <li class="footer"><a href="#">Voir tout les Mails</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu scale-up">
              ...
              <li class="footer"><a href="#">Les Voir toutes</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu scale-up">
              <li class="header">Aucune tache</li>
              <!--<li>
                <!-- inner menu: contains the actual data ->
                <ul class="menu inner-content-div">
                  <li><!-- Task item ->
