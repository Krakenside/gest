      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Statistiques de ventes</li>
                ...
                <div class="formContainer">
                    <!-- Lister les maisons de production -->
                    <form action="statmaison.php" method="get">
                        <select name="chM" id="">
                            <option value="">--------- Choisir la maison de production ---------</option>
                            <?php

                            $resMSt = $bdd->prepare($reqM);
                            $resMSt->execute();
                            $resst = $resMSt->fetchAll();
                            foreach ($resst as $q) {


                            ?>
                                <option value="<?php echo $q['id_maison'];  ?>" <?php if (isset($chM)) {
                                                                                    if ($chM == $q['id_maison']) {
                                                                                        echo "selected";
                                                                                    }
                                                                                } ?>> <?php echo $q['nom_maison']; ?></option>
                    ...
                    <table class="table table-bordered" id="mydata">
                        <thead>
                            <tr>
                                ...
                                <th>Artiste</th>
                                <th>Ventes de Single</th>
                                <th>Ventes d'albums </th>
                                <th>Details</th>
                ...
                if ($("#mydata").length) {
                    $("#mydata").DataTable({
                        ...
                        ajax: {
                            ...
                            "url": "stmsapi.php?table=transaction&a=1&idMsn=<?php echo $_GET["chM"]?>&p=3",
                            "dataSrc": "",
                            "type": "GET"
                        },
                        buttons: [{
